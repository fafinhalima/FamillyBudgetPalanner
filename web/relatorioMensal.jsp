    ...
    <body>
        <%
            ...
            String sql = "select sum(valorLancamentoEntrada) as valor,descricao from categoria inner join lacamento_entrada on"+ 
                        ...
                        " where categoria.loginUsuario = '"+UsuarioBean.loginUsuario+"' and Year(dataLancamentoEntrada) = Year(now()) and month(dataLancamentoEntrada)= month(now()) and tipo_entrada_saida = 1"+
                        " group by descricao";
